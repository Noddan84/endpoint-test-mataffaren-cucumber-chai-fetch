Feature: Sort products by topRated
  As a REST api user I want to be able to sort products by topRated and have the information be correct in all categories
  ...
  Scenario: topRated
    ...
    And the test should show that the "responsedata" has property "topRated"
